...
- **Tipologi 2: Akses dekat, jaringan jalan jarang**: 27.019 baris (33,73 %); waktu minimum median 4,16 [P75 5,60; P90 6,83] menit, rerata 4,21; > 30 menit 0,00 %; Terputus 0,00 %; terisolasi 0,000
- **Tipologi 3: Akses sedang, jaringan jalan jarang**: 31.263 baris (39,03 %); waktu minimum median 9,76 [P75 13,05; P90 18,09] menit, rerata 11,66; > 30 menit 2,60 %; Terputus 0,06 %; terisolasi 0,001
- **Tipologi 4: Akses terputus, jaringan jalan paling jarang**: 1.389 baris (1,73 %); waktu minimum median 403,29 [P75 403,29; P90 403,29] menit, rerata 390,57; > 30 menit 98,92 %; Terputus 96,54 %; terisolasi 0,965
...
- Baseline → Rendah (transisi tipologi): SR 99,49 %; ARI 0,986; dominan Tipologi 1 → Tipologi 2 (61); CDVM 0,003
- Rendah → Sedang (transisi tipologi): SR 87,08 %; ARI 0,682; dominan Tipologi 1 → Tipologi 2 (1.128); CDVM 0,070
- Sedang → Tinggi (transisi tipologi): SR 77,51 %; ARI 0,480; dominan Tipologi 2 → Tipologi 3 (1.488); CDVM 0,139
- Baseline → Tinggi (transisi tipologi): SR 71,18 %; ARI 0,373; dominan Tipologi 2 → Tipologi 3 (1.614); CDVM 0,177
...
- **Tipologi 2: Akses lebih jauh, jaringan jalan jarang**: 41.375 baris (51,65 %); waktu minimum median 8,70 [P75 12,36; P90 18,91] menit, rerata 22,48; > 30 menit 5,19 %; Terputus 3,20 %; terisolasi 0,032
...
- Baseline → Rendah (transisi tipologi): SR 99,78 %; ARI 0,991; dominan Tipologi 1 → Tipologi 2 (48); CDVM 0,002
- Rendah → Sedang (transisi tipologi): SR 92,38 %; ARI 0,718; dominan Tipologi 1 → Tipologi 2 (1.437); CDVM 0,073
- Sedang → Tinggi (transisi tipologi): SR 82,88 %; ARI 0,432; dominan Tipologi 1 → Tipologi 2 (2.638); CDVM 0,169
- Baseline → Tinggi (transisi tipologi): SR 77,09 %; ARI 0,293; dominan Tipologi 1 → Tipologi 2 (3.534); CDVM 0,227
...
- **Tipologi 2: Akses dekat, jaringan jalan jarang**: 34.612 baris (43,21 %); waktu minimum median 5,64 [P75 7,61; P90 9,47] menit, rerata 6,66; > 30 menit 0,22 %; Terputus 0,22 %; terisolasi 0,002
- **Tipologi 3: Akses jauh, jaringan jalan paling jarang**: 21.801 baris (27,22 %); waktu minimum median 11,70 [P75 16,36; P90 28,94] menit, rerata 35,56; > 30 menit 9,59 %; Terputus 5,80 %; terisolasi 0,058
...
- Baseline → Rendah (transisi tipologi): SR 99,52 %; ARI 0,985; dominan Tipologi 1 → Tipologi 2 (61); CDVM 0,003
- Rendah → Sedang (transisi tipologi): SR 86,79 %; ARI 0,640; dominan Tipologi 1 → Tipologi 2 (1.182); CDVM 0,067
- Sedang → Tinggi (transisi tipologi): SR 70,19 %; ARI 0,317; dominan Tipologi 2 → Tipologi 3 (2.819); CDVM 0,215
- Baseline → Tinggi (transisi tipologi): SR 62,41 %; ARI 0,222; dominan Tipologi 2 → Tipologi 3 (3.287); CDVM 0,264
